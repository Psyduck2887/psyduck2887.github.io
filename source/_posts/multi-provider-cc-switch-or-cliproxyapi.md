...
写这篇，是因为看到有人在争论：**用 CC Switch 好，还是用 CLIProxyAPI 好**。  
争论有道理——CC Switch 本身也带一定的**反向代理**能力，两边看起来都能「把流量转出去」，于是就容易吵成「二选一」。

**一条硬提醒：**  
如果你用的是 **Anthropic 官方账号**，**一定不要走反向代理**。很容易露头，轻则异常、重则账号秒没。  
下面说的 CLIProxyAPI 路由、多供应商，都默认你用的是**允许被代理/转发**的通道或供应商；**不要把 Anthropic 官方账号硬塞进反代链路**。
...
再次强调：这是给**允许这种接法的供应商**用的；**Anthropic 官方账号不要拿来反代**，也别指望靠「换个入口」绕过风险。
